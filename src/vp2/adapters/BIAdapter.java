...
public class BIAdapter extends ArrayAdapter<BI> {
	...
	public BIAdapter(Context con,
				int textViewResourceId, List<BI> objects) {
	...
	private View getView_B4_v1_0(
		...
		BI item = getItem(position);
		
		Long start_time = item.getStartTime();
